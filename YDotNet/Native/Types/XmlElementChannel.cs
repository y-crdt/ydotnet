...
internal static class XmlElementChannel
{
    ...
    [DllImport(
        ChannelSettings.NativeLib,
        CallingConvention = CallingConvention.Cdecl,
        EntryPoint = "yxmlelem_tree_walker")]
    ...
    [DllImport(
        ChannelSettings.NativeLib,
        CallingConvention = CallingConvention.Cdecl,
        EntryPoint = "yxmlelem_event_target")]
    public static extern nint ObserveEventTarget(nint eventHandle);

    [DllImport(
        ChannelSettings.NativeLib,
        CallingConvention = CallingConvention.Cdecl,
        EntryPoint = "yxmlelem_event_path")]
