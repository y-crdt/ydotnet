...
public class GetTests
{
    ...
    public void GetNull()
    {
        ...
        Assert.That(value2.Type, Is.Not.EqualTo(OutputType.Null));
        Assert.That(value3.Type, Is.Not.EqualTo(OutputType.Null));
    }
    ...
    public void GetUndefined()
    {
        ...
        Assert.That(value2.Type, Is.Not.EqualTo(OutputType.Undefined));
        Assert.That(value3.Type, Is.Not.EqualTo(OutputType.Undefined));
    }
